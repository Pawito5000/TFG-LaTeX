...
% Estilo de citas IEEE sencillo: usar paquete cite para comprimir y ordenar referencias numéricas
\usepackage{cite}
...
\input{Gestión económica/main}

\input{Informe de sostenibilidad/main}
